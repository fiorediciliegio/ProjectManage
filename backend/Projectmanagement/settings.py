...
ELASTICSEARCH_REQUEST_TIMEOUT = int(os.getenv('ELASTICSEARCH_REQUEST_TIMEOUT', '20'))
ELASTICSEARCH_MAX_RETRIES = int(os.getenv('ELASTICSEARCH_MAX_RETRIES', '2'))
ELASTICSEARCH_BULK_CHUNK_SIZE = int(os.getenv('ELASTICSEARCH_BULK_CHUNK_SIZE', '100'))
ELASTICSEARCH_BULK_REQUEST_TIMEOUT = int(os.getenv('ELASTICSEARCH_BULK_REQUEST_TIMEOUT', '60'))
RAG_KEYWORD_INDEX_REQUIRED = env_bool('RAG_KEYWORD_INDEX_REQUIRED', False)
...
RAG_SEMANTIC_CHUNKING_ENABLED = env_bool('RAG_SEMANTIC_CHUNKING_ENABLED', True)
RAG_SEMANTIC_CHUNKING_MIN_BLOCK_CHARS = int(os.getenv('RAG_SEMANTIC_CHUNKING_MIN_BLOCK_CHARS', '80'))
RAG_SEMANTIC_CHUNKING_TARGET_CHARS = int(os.getenv('RAG_SEMANTIC_CHUNKING_TARGET_CHARS', '900'))
RAG_SEMANTIC_CHUNKING_MAX_CHUNK_CHARS = int(os.getenv('RAG_SEMANTIC_CHUNKING_MAX_CHUNK_CHARS', '1400'))
RAG_SEMANTIC_CHUNKING_SIMILARITY_THRESHOLD = float(os.getenv('RAG_SEMANTIC_CHUNKING_SIMILARITY_THRESHOLD', '0.62'))
RAG_SEMANTIC_CHUNKING_SHORT_MERGE_MIN_SIMILARITY = float(os.getenv('RAG_SEMANTIC_CHUNKING_SHORT_MERGE_MIN_SIMILARITY', '0.5'))
RAG_SEMANTIC_CHUNKING_EMBED_TEXT_CHARS = int(os.getenv('RAG_SEMANTIC_CHUNKING_EMBED_TEXT_CHARS', '900'))
...
RAG_CHAT_MODEL = os.getenv('RAG_CHAT_MODEL', 'qwen3.8-max')
RAG_CHAT_TIMEOUT = int(os.getenv('RAG_CHAT_TIMEOUT', '45'))
RAG_CHAT_MAX_TOKENS = int(os.getenv('RAG_CHAT_MAX_TOKENS', '2400'))
...
RAG_CHAT_MEMORY_SUMMARY_MAX_TOKENS = int(os.getenv('RAG_CHAT_MEMORY_SUMMARY_MAX_TOKENS', '1800'))
RAG_CHAT_QUERY_REWRITE_MAX_TOKENS = int(os.getenv('RAG_CHAT_QUERY_REWRITE_MAX_TOKENS', '512'))
...
RAG_MULTI_QUERY_MAX_TOKENS = int(os.getenv('RAG_MULTI_QUERY_MAX_TOKENS', '384'))
...
RAG_LLM_CONTEXT_COMPRESSION_MAX_TOKENS = int(os.getenv('RAG_LLM_CONTEXT_COMPRESSION_MAX_TOKENS', '1600'))
...
RAGAS_EVAL_MAX_TOKENS = int(os.getenv('RAGAS_EVAL_MAX_TOKENS', '4096'))
RAGAS_EVAL_ENABLE_THINKING = env_bool('RAGAS_EVAL_ENABLE_THINKING', False)
RAGAS_EVAL_N = int(os.getenv('RAGAS_EVAL_N', '1'))
RAGAS_EVAL_TIMEOUT = int(os.getenv('RAGAS_EVAL_TIMEOUT', '240'))
RAGAS_EVAL_MAX_RETRIES = int(os.getenv('RAGAS_EVAL_MAX_RETRIES', '1'))
